  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        lifted: "0 10px 40px -10px rgb(16 24 40 / 0.18), 0 4px 10px -4px rgb(16 24 40 / 0.08)",
        glow: "0 0 0 1px hsl(var(--primary) / 0.2), 0 10px 30px -10px hsl(var(--primary) / 0.35)",
      },
      backgroundImage: {
        "grid-light":
        ...
        "hero-gradient":
          "radial-gradient(at 20% 0%, hsl(var(--primary) / 0.15) 0%, transparent 50%), radial-gradient(at 80% 0%, hsl(var(--accent) / 0.12) 0%, transparent 50%)",
      },
      keyframes: {
